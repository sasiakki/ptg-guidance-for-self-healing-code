export const Constants = {
	work_category: { // training category
		TERMINATED: 'TERM',
	...
	//Credential Status: Expired,Active,DOH Negative Status- No Work,Pending,Closed
	credential_status: {
		EXPIRED: 'Expired',
		ACTIVE: 'Active',
	...
	//Credential Type: AP, LP, NA, NC, RN, HM, OSPI 
	credential_type: {
	...
	BT_REHIRE_MIN: '2019-08-17', 
	BT_REHIRE_EXTENSION_DAYS: 119, 

	//Expired credential is renewable timelimit is in years;
	EXPIRED_CREDENTIAL_ISRENEABLE_TIMELIMIT: '5',

	//Reason shortcodes for BCDD
	// Benefits Continuation -> BC
	// Emergency Rule Rehire -> ERH
	// Covid19 Emergency Rule -> CV19
	// Break In Service Rehire -> BIS
	// HB1694 Legislation Rehire -> RH
	bcdd_reason_code: {
		ER_REHIRE: 'ERH',
		COVID19: 'CV19',
