...
class Student_training_bt_rule {
    ...
    static isBtEligible(student, trainings, courseCode) {
        ...
        let isOSCompleted = false;
        let isBTCompleted = false;
        isOSCompleted = helper_1.Helper.hasCompletedTraining(consts_1.Constants.training_code.OS.CODE, trainings);
        isBTCompleted = helper_1.Helper.hasCompletedTraining(courseCode, trainings);
