...
#Qualtrics manual transfers file is currently being uploaded to the S3 location by BA's, 
#As part of this we are not using this glue job in E2E process.


#This script was added as a reference from the old repo, so the code has been commented.
