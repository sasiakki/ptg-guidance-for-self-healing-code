...
def execute_sp():
	...
	try:
		...
		cur = conn.cursor()
		print("Calling SP staging.sp_transcriptretractionprocess - Started")
		cur.execute("begin;")
		cur.execute("CALL staging.sp_transcriptretractionprocess()")
		cur.execute("commit;")
		print("Calling SP staging.sp_transcriptretractionprocess - Completed")
	except:
		raise Error
