...
outboundtypes = [
    {
        "pathfilter":"Outbound/doh/completed/",
        "filenameformatprefix":"Completed_Prometric_BT75_Students_",
        "filetypeformatsufix":"_1.txt",
        "filecategory": "doh-completed",
        "latestprocesseddate":read_from_sftpoutboundfilelog("doh-completed")
     }  
]
