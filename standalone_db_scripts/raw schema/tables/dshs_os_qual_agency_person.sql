-- Table: raw.dshs_os_qual_agency_person

-- DROP TABLE IF EXISTS "raw".dshs_os_qual_agency_person;

CREATE TABLE IF NOT EXISTS "raw".dshs_os_qual_agency_person
(
    ...
    person_firstname character varying(1000) COLLATE pg_catalog."default",
    ...
    dshs_id character varying(1000) COLLATE pg_catalog."default",
...
ALTER TABLE IF EXISTS "raw".dshs_os_qual_agency_person
    OWNER to cicd_pipeline;

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE "raw".dshs_os_qual_agency_person TO anveeraprasad;

GRANT ALL ON TABLE "raw".dshs_os_qual_agency_person TO cicd_pipeline;

GRANT SELECT ON TABLE "raw".dshs_os_qual_agency_person TO cukaumunna;

GRANT SELECT ON TABLE "raw".dshs_os_qual_agency_person TO lizawu;

GRANT SELECT ON TABLE "raw".dshs_os_qual_agency_person TO readonly_testing;

GRANT ALL ON TABLE "raw".dshs_os_qual_agency_person TO system_pipeline;